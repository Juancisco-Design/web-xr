...
export default function regalo2 ({x, y, z}) 
{
    ...
    var texture = new THREE.TextureLoader().load("./assets/2.jpg")
...
var regalito2 = new THREE.Group();
regalito2.add(mesh, mesh1, mesh2,  mesh3);
regalito2.position.set(x, y, z);  
return regalito2;
}
