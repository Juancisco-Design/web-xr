...
export default function regalo1 ({x, y, z}) 
{
    ...
    var texture = new THREE.TextureLoader().load("./assets/1.jpg")
...
var regalito1 = new THREE.Group();
regalito1.add(mesh, mesh1, mesh2,  mesh3);
regalito1.position.set(x, y, z);  
return regalito1;
}
