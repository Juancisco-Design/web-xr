...
export default function esfera1 ({x, y, z}) 
{

 // ESFERA
 var geometriaEsfera = new THREE.SphereGeometry(5);
 var texturaEsfera = new THREE.TextureLoader().load("./assets/estrella.jpg");
...
var esferita1 = new THREE.Group();
esferita1.add(mallaEsfera, mallaCilindro1, mallaCilindro2,  mallaTorus);
esferita1.position.set(x, y, z);  
return esferita1;
}
